  ...
  const faqs = [
    {
      ...
      a: 'We support MP3, WAV, M4A, FLAC and OGG formats up to 100MB per file.'
    },
    {
      q: 'How accurate is the AI transcription?',
      a: 'Our Whisper AI provides 95%+ accuracy for clear audio in English and many other languages.'
    },
    {
      q: 'Is my call data private?',
      a: 'Yes! Each organization has isolated data. No other organization can see your calls.'
    },
    {
      q: 'Can I try it for free?',
      a: 'Yes! Our free plan includes 5 calls per month with full AI analysis features.'
    },
    {
      q: 'How do team members join?',
      a: 'After creating an organization, you get a unique code. Share it with your team to join instantly.'
    },
  ]
    ...
    >
      ...
      <section style={{
        ...
        <p style={{
          ...
          Upload your sales calls and get instant AI analysis,
          sentiment tracking, objection detection, and
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <p style={{
              ...
              Powerful AI tools to supercharge your sales team
            </p>
          </div>
      ...
      >
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            ...
            <p style={{ color: '#666', fontSize: '18px', marginTop: '12px' }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          Join organizations already using Sales.AI
        </p>
        <button
          onClick={() => navigate('/register/organization')}
          style={{
